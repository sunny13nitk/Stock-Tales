 ...
 *   - DEfined with : Scrip Sheet Name, Key attribute, Attribute1, Attribute2, Kind of Operation - EnumCalcOperation
 ...
 *
 */
public @interface ScripCalcAttrList
{
	String label() default "";
	
	String sheetName() default SheetNames.Analysis;
	
	String keyAttr() default "year";
	
	String attr1() default "";
	
	String attr2() default "";
	
	EnumCalcOperation operator() default EnumCalcOperation.IncrementalDelta;
